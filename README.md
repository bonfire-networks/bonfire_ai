...
```
cd extensions
git clone https://github.com/bonfire-networks/bonfire.ai.git {your-extension-name-here}
...
- Rename all the modules names to match your extension name:
    ...
    - Find & replace bonfire.ai -> bonfire_your_extension_name
- Rename the `bonfire.ai.exs` config file to match your extension name `bonfire_your_extension_name.exs`
